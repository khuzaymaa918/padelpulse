        ...
        {TABS.map((tab) => (
          <button
            ...
            className={`px-5 py-2.5 text-[0.65rem] tracking-[0.12em] uppercase transition-colors ${
              activeTab === tab
                ? "bg-white text-black"
                : "bg-[#0d0d0d] text-white/40 hover:text-white"
            }`}
          >
        ...
        {filtered.length === 0 ? (
          ...
          filtered.map((order) => (
            ...
            >
              ...
              <div className="font-display text-[1rem]">
...
function StatusBadge({ status }: { status: string }) {
  ...
  return (
    <span className={`text-[0.58rem] tracking-[0.12em] uppercase border px-2 py-1 w-fit ${
